...
def insertionSort(array):
    ...
    while idx < len(array):
        insertion_idx = idx
        while insertion_idx>0 and array[insertion_idx]<array[insertion_idx-1]:
                array[insertion_idx], array[insertion_idx-1] = array[insertion_idx-1], array[insertion_idx]
                insertion_idx -= 1
        idx += 1
...
def test_insertionSort(array, expected):

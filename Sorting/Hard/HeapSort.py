...
def siftDown(array, end):
    idx = 0
    child1 = 2*idx+1
    while child1<end:
        child2 = child1+1
        idxToSwap = child2 if child2<end and array[child2]>array[child1] else child1
        if array[idxToSwap]>array[idx]:
            array[idxToSwap], array[idx] = array[idx], array[idxToSwap]
            idx = idxToSwap
            child1 = 2*idx+1
        else:
            break
...
def test_heapSort(array, expected):
    assert heapSort(array)==expected
